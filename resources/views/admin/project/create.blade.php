    ...
    <div class="container">
        ...
        <form action="{{ route('admin.project.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                @foreach ($technologys as $technology)
                    <div class="form-check form-check-inline">
                        <input class="btn-check" type="checkbox" name="technologies[]" value="{{ $technology->id }}" id="technology_{{ $technology->id }}">
                        <label class="btn btn-outline-success btn-sm" for="technology_{{ $technology->id }}">
                            {{ $technology->name }}
                        </label>
                    </div>
                @endforeach
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" aria-describedby="basic-addon3" id="author" name="author">
            </div>
